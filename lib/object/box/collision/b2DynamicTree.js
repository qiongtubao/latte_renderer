 	...
 	function(require, exports, module, window) {
         ...
         (function() {
            ...
            this.CreateProxy = function(aabb, userData) {
               ...
               var extendX = Settings.b2_aabbExtension;
               var extendY = Settings.b2_aabbExtension;
            ...
            */
            this.MoveProxy = function(proxy, aabb, displacement) {
               ...
               var extendX = Settings.b2_aabbExtension + Settings.b2_aabbMultiplier * (displacement.x > 0 ? displacement.x : (-displacement.x));
               var extendY = Settings.b2_aabbExtension + Settings.b2_aabbMultiplier * (displacement.y > 0 ? displacement.y : (-displacement.y));
