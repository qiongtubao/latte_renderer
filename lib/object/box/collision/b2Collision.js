	...
	define("latte_renderer/object/box/collision/b2Collision", ["require", "exports", "module", "window"],
 	function(require, exports, module, window) {
 		...
 		(function() {
 			this.MakeClipPointVector = function () {
		   	...
		   	*/
		   	...
		   	/**
		   		矩形和矩形的接触
		   	*/
		   	this.CollidePolygons = function(manifold, polyA, xfA, polyB, xfB) {
		   		var cv;
		   		manifold.m_pointCount = 0;
		   	...
		   	*/
		   	this.FindMaxSeparation = function (edgeIndex, poly1, xf1, poly2, xf2) {
		      var count1 = parseInt(poly1.m_vertexCount);
		   ...
		   /**
		   		边缘间距
				b2Collision.FindMaxSeparation ->
		   */

		   this.EdgeSeparation = function (poly1, xf1, edge1, poly2, xf2) {
		   	...
		   	/**
		   		b2Collision.CollidePolygons->
		   	*/
		   	this.FindIncidentEdge = function (c, poly1, xf1, edge1, poly2, xf2) {
			      if (edge1 === undefined) edge1 = 0;
			      var count1 = parseInt(poly1.m_vertexCount);
			      var normals1 = poly1.m_normals;
			      var count2 = parseInt(poly2.m_vertexCount);
   			...
   			/**
   				圆和圆的碰撞
   			*/
   			this.CollideCircles = function (manifold, circle1, xf1, circle2, xf2) {
			      manifold.m_pointCount = 0;
			      var tMat;
			      var tVec;
			      tMat = xf1.R;
		   ...
		   /**
		   		b2Collision.CollidePolygons->
		   */
		   this.ClipSegmentToLine = function (vOut, vIn, normal, offset) {
		   	...
		   	this.s_edgeAO = box2D.NVector(1);
		   	this.s_edgeBO = box2D.NVector(1);
