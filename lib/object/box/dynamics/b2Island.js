            ...
            */
            this.Solve = function(step, gravity, allowSleep) {
               ...
               for(i = 0; i < this.m_bodyCount; ++i) {
                  ...
                  if(rotation * rotation > Settings.b2_maxRotationSquared) {
                        ...
                        b.m_angularVelocity = 
                           ...
                           (-Settings.b2_maxRotation * step.inv_dt): 
                           Settings.b2_maxRotation * step.inv_dt;
               ...
               if(allowSleep) {
                  ...
                  var linTolSqr = Settings.b2_linearSlinearSleepTolerance * Settings.linearSlinearSleepTolerance;
                  var angTolSqr = Settings.b2_angularSleepTolerance * Settings.angularSleepTolerance;
                  for( i = 0 ; i < this.m_bodyCount; ++i) {
                     b = this.m_bodies[i];
                     ...
                     if((b.m_flags & b2Body.e_allowSleepFlag) == 0 || b.m_angularVelocity * b.m_angularVelocity > angTolSqr || mMath.Dot(b.m_linearVelocity, b.m_linearVelocity) > linTolSqr) {
                        b.m_sleepTime = 0.0;
                        minSleepTime = 0.0;
                     }else{
