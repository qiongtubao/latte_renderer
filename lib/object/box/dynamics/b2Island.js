            ...
            */
            this.Solve = function(step, gravity, allowSleep) {
               ...
               if(allowSleep) {
                  ...
                  var linTolSqr = Settings.b2_linearSleepTolerance * Settings.b2_linearSleepTolerance;
                  var angTolSqr = Settings.b2_angularSleepTolerance * Settings.b2_angularSleepTolerance;
                  for( i = 0 ; i < this.m_bodyCount; ++i) {
                     b = this.m_bodies[i];
