   ...
   function(require, exports, module, window) {
         ...
         */
         var TimeStep = require("./b2TimeStep")
            ...
            , b2PositionSolverManifold = require("./contacts/b2PositionSolverManifold");
   		...
   		(function() {
            ...
            this.initVelocityConstraints = function(step, contacts, contactCount, allocator) {
               ...
               for (i = 0; i < contactCount; ++i) {
                  ...
                  var bodyB = fixtureB.m_body;
                  var manifold = contact.GetManifold();
                  var friction = b2Settings.MixFriction(fixtureA.GetFriction(), fixtureB.GetFriction());
                  ...
                  var wA = bodyA.m_angularVelocity;
                  var wB = bodyB.m_angularVelocity;
                  b2Settings.Assert(manifold.m_pointCount > 0);
            ...
            this.solvePositionConstraints = function(baumgarte) {
               ...
               for (var i = 0; i < this.m_constraintCount; i++) {
                  ...
                  for (var j = 0; j < c.pointCount; j++) {
                     ...
                     var C = mMath.clamp(baumgarte * (separation + b2Settings.linearSlop), (-b2Settings.maxLinearCorrection), 0.0);
   		...
   		}).call(b2ContactSolver.prototype);
         (function() {
            this.s_worldManifold = new b2WorldManifold();
            this.s_psm = new b2PositionSolverManifold();
         }).call(b2ContactSolver);
