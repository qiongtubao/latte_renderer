(function(define) { 'use strict';
   ...
   function(require, exports, module, window) {
   		...
   		(function() {   			
			...
			this.b2_polygonRadius = 2.0 * Settings.b2_linearSlop;
			this.b2_linearSlop = 0.005;
			this.b2_angularSlop = 2.0 / 180.0 * Settings.b2_pi;
			this.b2_toiSlop = 8.0 * Settings.b2_linearSlop;
			...
			this.b2_maxAngularCorrection = 8.0 / 180.0 * Settings.b2_pi;
			this.b2_maxTranslation = 2.0;
			this.b2_maxTranslationSquared = Settings.b2_maxTranslation * Settings.b2_maxTranslation;
			this.b2_maxRotation = 0.5 * Settings.b2_pi;
			this.b2_maxRotationSquared = Settings.b2_maxRotation * Settings.b2_maxRotation;
			this.b2_contactBaumgarte = 0.2;
			this.b2_timeToSleep = 0.5;
			this.b2_linearSleepTolerance = 0.01;
			this.b2_angularSleepTolerance = 2.0 / 180.0 * Settings.b2_pi;
